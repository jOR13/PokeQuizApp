...
class QuizzesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quiz" do
    assert_difference('Player.count') do
      post quizzes_url, params: { player: { name: "Test Player" } }
    end
  ...
  test "should show quiz" do
    ...
    quiz = Quiz.create(content: { questions: [{ question: "Test question?", options: ["Option 1", "Option 2"], answer: "Option 1", player_answer: nil }] })
